...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn("mx-2 my-3 w-auto bg-sidebar-border", className)}
      {...props}
    />
  );
});
